...
function getQualityInfo(format?: string, sampleRate?: string, bitDepth?: string): QualityInfo {
  ...
  // Build human‑readable details string (e.g. "CD 16-bit 44.1kHz" or "Hi-Res 24-bit 96kHz")
  const parts: string[] = [];
  ...
  if (bits) {
    ...
    // The user will see "Hi-Res 96kHz" which is better than nothing
  }
...
export default function NowPlayingScreen() {
  ...
  // Clean, simple pan gesture - works from anywhere on screen
  const panGesture = Gesture.Pan()
    .activeOffsetY(5)
    .failOffsetX([-30, 30])
    .onStart(() => {
      // Disable scrolling when gesture starts - allows gesture to work from anywhere
            ...
            >
              ...
              >
                ...
                <View style={styles.addMenuItems}>
                  ...
                  >
                    <MaterialCommunityIcons name="radio" size={22} color="#FFFFFF" />
