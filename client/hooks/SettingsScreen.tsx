                  ...
                  <Pressable
                    ...
                    onPress={async () => {
                      try {
                        ...
                        // For mobile, we'd typically open this URL in a web browser
                        // and handle the redirect back to the app
                        Alert.alert(
                          'Tidal Authentication',
                          'Please visit this URL in your browser to authenticate with Tidal:\n\n' + authUrl,
                          [
                            { text: 'Copy URL', onPress: () => Clipboard.setStringAsync(authUrl) },
                            { text: 'OK' }
                          ]
                        );
                      } catch (error) {
