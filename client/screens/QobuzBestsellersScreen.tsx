...
const VIEW_MODE_KEY = "@qobuz_bestsellers_view_mode";
const SORT_KEY = "@qobuz_bestsellers_sort";
...
export default function QobuzBestsellersScreen() {
  ...
  useEffect(() => {
    const loadBestsellers = async () => {
      ...
      try {
        ...
        const lmsAlbums = await lmsClient.getQobuzBestsellerAlbums(1000, activePlayer?.id);
        ...
        console.error("Failed to load Qobuz bestsellers:", error);
        setAlbums([]);
      } finally {
        setIsLoading(false);
      }
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <ThemedText style={styles.emptyText}>No bestsellers available</ThemedText>
          </View>
        }
      />
